  ...
  <v-container fluid class="pa-4">
    ...
    <v-card>
      <v-card-title>
        ...
        Gastos ({{ filteredInvoices.length }})
      </v-card-title>
...
export default {
  ...
  methods: {
    ...
    async loadInvoices() {
      this.loading = true
      try {
        console.log('🔄 Cargando gastos (facturas de VENTA) de la organización...')
        ...
        this.invoices = resp || []
        console.log('✅ Gastos cargados:', this.invoices.length)
        this.computeStats()
      } catch (e) {
