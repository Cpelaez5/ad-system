<template>
  <div class="pricing-section py-16 bg-grey-lighten-5" id="pricing">
    <v-container>
      <!-- Header -->
      ...
      <v-row justify="center" align="stretch" class="mb-16 pt-4">
        ...
        <v-col cols="12" md="4" lg="3">
          <v-card class="pricing-card h-100 d-flex flex-column pt-6 pb-4 px-4" elevation="0" border>
            ...
            <v-card-text class="flex-grow-1 mt-4">
              <v-btn block color="grey-darken-4" class="mb-8 text-none" rounded="lg" elevation="2" @click="handlePlanSelection('basic')">
                Comenzar ahora
              </v-btn>
        ...
        <v-col cols="12" md="4" lg="3">
          <v-card class="pricing-card popular h-100 d-flex flex-column pt-6 pb-4 px-4 position-relative overflow-visible" elevation="10" border color="white">
            ...
            <v-card-text class="flex-grow-1 mt-4">
              <v-btn block color="primary" class="mb-8 text-none" rounded="lg" size="large" elevation="4" @click="handlePlanSelection('pro')">
                Obtener Profesional
              </v-btn>
        ...
        <v-col cols="12" md="4" lg="3">
          <v-card class="pricing-card h-100 d-flex flex-column pt-6 pb-4 px-4" elevation="0" border>
            ...
            <v-card-text class="flex-grow-1 mt-4">
              <v-btn block variant="outlined" color="primary" class="mb-8 text-none" rounded="lg" @click="handlePlanSelection('enterprise')">
                Contactar Ventas
              </v-btn>
      ...
      <v-row justify="center">
        <v-col cols="12" md="8">
          ...
          <v-expansion-panels variant="default" class="custom-panels bg-transparent">
            <v-expansion-panel elevation="0" class="mb-2 border rounded-lg bg-white">
