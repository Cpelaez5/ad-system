  ...
  properties: {
    ...
    financial: {
      ...
      properties: {
        ...
        ivaRetention:     { type: 'NUMBER', nullable: true, description: 'Monto retenido por concepto de IVA' },
        islrRetention:    { type: 'NUMBER', nullable: true, description: 'Monto retenido por concepto de ISLR (Impuesto sobre la Renta)' },
        municipalRetention:{ type: 'NUMBER', nullable: true, description: 'Monto retenido por impuestos municipales o patente' },
